class Ingredient {
  ...
  factory Ingredient.fromJson(Map<String, dynamic> json) {
    ...
    return Ingredient(
      ...
      core: Core.fromJson(_asMap(json['core'], 'core')),
      ...
      risk: Risk.fromJson(_asMap(json['risk'], 'risk')),
      health: json['health'] is Map ? Health.fromJson(json['health']) : Health.empty(),
      allergen:
          json['allergen'] is Map ? Allergen.fromJson(json['allergen']) : Allergen.empty(),
      dietary:
          json['dietary'] is Map ? Dietary.fromJson(json['dietary']) : Dietary.empty(),
      usage: json['usage'] is Map ? Usage.fromJson(json['usage']) : Usage.empty(),
      consumer:
          json['consumer'] is Map ? Consumer.fromJson(json['consumer']) : Consumer.empty(),
...
class Risk {
  ...
  factory Risk.fromJson(Map<String, dynamic> json) => Risk(
        ...
        labelColor: (json['label_color'] ?? (json['risk_level'] ?? 'green')).toString(),
...
class Health {
  ...
  factory Health.fromJson(Map json) => Health(
        healthFlags: (json['health_flags'] is List)
            ...
            : <String>[],
        claims: const [], // claims detaylı değil şimdilik
